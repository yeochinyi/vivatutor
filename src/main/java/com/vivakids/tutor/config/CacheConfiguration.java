package com.vivakids.tutor.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.vivakids.tutor.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.vivakids.tutor.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
